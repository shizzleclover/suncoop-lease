...
const defaultFaqGroups: FaqGroup[] = [
    {
        ...
        items: [
            { id: "item1", q: "What does Flexpay offer?", a: "Flexible payment options for solar energy solutions." },
            { id: "item2", q: "What does it cost to get started?", a: "Getting started is affordable with our subscription model." },
        ],
    },
]

export default function FlexpayFaqSection() {
