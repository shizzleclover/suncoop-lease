...
export default function BenefitsEditor() {
    ...
    const deleteBenefit = async (index: number) => {
        ...
        if (benefit._id) {
            await fetch(`/api/benefits/${benefit._id}`, { method: "DELETE" })
        }
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h1 className="text-2xl font-bold text-gray-800">Benefits Section</h1>
                    <p className="text-gray-500 text-sm">Manage your benefit cards</p>
                </div>
            ...
            <div className="flex gap-2 mb-6 border-b border-gray-200">
                <button
                    ...
                    className={`flex items-center gap-2 px-4 py-3 font-medium border-b-2 -mb-px ${activeTab === "items" ? "text-yellow-600 border-yellow-500" : "text-gray-500 border-transparent"}`}
                >
                ...
                <div className="space-y-3">
                    {benefits.length === 0 ? (
                        <div className="text-center py-12 bg-white rounded-lg border border-dashed border-gray-300">
                            ...
                            <button onClick={addBenefit} className="px-4 py-2 bg-yellow-500 text-black font-bold rounded-lg hover:bg-yellow-400">
