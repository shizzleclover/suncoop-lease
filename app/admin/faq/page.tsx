...
import { Save, Loader2, Plus, Trash2, ChevronDown, ChevronUp, Palette, Type } from "lucide-react"
...
const defaultGroups = ["Before you GoSolar", "The Suncoopng solution", "Installation", "Post installation", "Referral programme"]
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h1 className="text-2xl font-bold text-gray-800">FAQ Section</h1>
            ...
            <div className="space-y-3">
                {faqs.length === 0 ? (
                    <div className="text-center py-12 bg-white rounded-lg border border-dashed border-gray-300">
                        ...
                        <button onClick={addFAQ} className="px-4 py-2 bg-yellow-500 text-black font-bold rounded-lg hover:bg-yellow-400">
                            Add Your First FAQ
                        </button>
                    </div>
                ) : (
                            ...
                            <div className="flex items-center gap-3 p-4">
                                <div className="flex-1">
                                    <input
                                        ...
                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-400 font-medium"
