        ...
        <div className="max-w-4xl mx-auto">
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-gray-500 text-sm">Edit the main banner of your website</p>
                </div>
                <button
                    onClick={handleSave}
                    disabled={isSaving}
                ...
                <div className="space-y-6 bg-white rounded-lg shadow p-6">
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-2">
                            ...
                            <button type="button" onClick={addBenefit} className="text-sm text-yellow-600 hover:text-yellow-700 font-medium">
                                + Add
                            </button>
                        </div>
