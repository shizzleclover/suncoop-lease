...
export default function FlexpayGlowEditor() {
    ...
    const handleSave = async () => {
        ...
        setMessage("")
        try {
            const res = await fetch("/api/content/flexpay-glow", {
                method: "PUT",
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h1 className="text-2xl font-bold text-gray-800">Flexpay Glow Section</h1>
                ...
                <div className="space-y-6 bg-white rounded-lg shadow p-6">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400 text-lg"
                        />
                    </div>
                    <div>
