...
const defaultContent: FooterContent = {
    ...
    tagline: "Flexible payment options for solar energy.",
    backgroundColor: "#1a1a1a",
    textColor: "#ffffff",
    accentColor: "#ffcd00",
}

export default function FlexpayFooterEditor() {
    ...
    useEffect(() => {
        fetch("/api/content/flexpay-footer")
    ...
    const handleSave = async () => {
        ...
        setMessage("")
        try {
            const res = await fetch("/api/content/flexpay-footer", {
                method: "PUT",
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h1 className="text-2xl font-bold text-gray-800">Flexpay Footer Section</h1>
                    <p className="text-gray-500 text-sm">Edit contact info and footer settings for Flexpay</p>
                </div>
            ...
            <div className="flex gap-2 mb-6 border-b border-gray-200">
                <button
                    ...
                    className={`flex items-center gap-2 px-4 py-3 font-medium border-b-2 -mb-px ${activeTab === "content" ? "text-blue-600 border-blue-500" : "text-gray-500 border-transparent"}`}
                >
